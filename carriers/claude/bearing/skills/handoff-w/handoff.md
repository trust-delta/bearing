...
∴ **これは 人間が呼ぶもの**であって、閾値で自動発火させるものではない。
...
2. **`composed-at` と `read-at` を控える。**
   ...
   - ⚠ **どちらも読むのを止める理由にはならない。** 警告もしない、確認も求めない。古い baton をあえて読ませたい場面はある。**事実だけ述べ、判断は 人間に残す。**
