...
import { placeSkill, inspectSkill, TEMPLATE_FILES, SKILL_DIR, chooseDir } from '../../../carriers/claude/bearing/bin/bearing-setup-aim.mjs'
import { parseStamp, stripStamp, withStamp, renderStamp, skillSha } from '../../../carriers/claude/bearing/lib/placed-skill.mjs'
import { renderBlock } from '../../../carriers/claude/bearing/lib/claude-md.mjs'
