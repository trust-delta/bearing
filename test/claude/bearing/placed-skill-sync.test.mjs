...
import { stripStamp, parseStamp, skillSha } from '../../../carriers/claude/bearing/lib/placed-skill.mjs'

const PLUGIN = path.join(import.meta.dirname, '..', '..', '..', 'carriers', 'claude', 'bearing')
