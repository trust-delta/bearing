...
import { DEFAULT_AIMS_DIR } from '../../../carriers/claude/bearing/lib/corpus.mjs'
...
const COMPOSER = path.join(HERE, '..', '..', '..', 'carriers', 'claude', 'bearing', 'bin', 'aim-facts.mjs')
const PLUGIN_ROOT = path.join(HERE, '..', '..', '..', 'carriers', 'claude', 'bearing')
