...
import { factsDigest, deltaStatePath } from '../../../carriers/claude/bearing/lib/corpus-signature.mjs'
import { renderCorpusDelta } from '../../../carriers/claude/bearing/lib/corpus-delta.mjs'
import { loadDesired, renderBlock } from '../../../carriers/claude/bearing/lib/claude-md.mjs'

const HERE = path.dirname(fileURLToPath(import.meta.url))
const HOOK = path.join(HERE, '..', '..', '..', 'carriers', 'claude', 'bearing', 'bin', 'corpus-delta.mjs')
const { version: VERSION, law: LAW } = await loadDesired(path.join(HERE, '..', '..', '..', 'carriers', 'claude', 'bearing'))
